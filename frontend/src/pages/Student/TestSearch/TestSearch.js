  ...
  return (
    <>
      ...
      <div className="mx-2 mt-6 flex h-12 flex-row items-center justify-center gap-2 ">
        ...
        <Link
          className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-tl from-cyan-500 via-blue-600 to-violet-700 text-white shadow-md"
          to={`/student/search?q=${searchText}`}
        >
            ...
            {tests.map((test, idx) => {
              return (
                ...
                >
                  ...
                  <div className="flex h-44 flex-col gap-4 px-1 py-4 md:px-2">
                    ...
                    {test.answered_questions ? (
                      <ProgressBar
                        percent={
                          (test.answered_questions / test.total_questions) * 100
                        }
                      />
                    ) : null}
                  </div>
